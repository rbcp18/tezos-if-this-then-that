...
def send_template_message(to_name, to_email, subject, text_line, main_title, trigger_text, action_text, id_trigger_action):
	print (to_name, to_email, subject, text_line, main_title, trigger_text, action_text, id_trigger_action)
...
<p style="font-size: 14px; line-height: 33px; text-align: center; margin: 0;"><span style="font-size: 28px;"><strong><span style="line-height: 33px; font-size: 28px;">"""+main_title+"""</span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: 'Trebuchet MS', Tahoma, sans-serif"><![endif]-->
...
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 3px; padding-left: 3px;" valign="top"><a href="TWITTER-URL" target="_blank"><img alt="Twitter" height="32" src="TWITTER-LOGO" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Twitter" width="32"/></a></td>
</tr>
</tbody>
</table>
</td>
...
<p style="font-size: 12px; line-height: 14px; text-align: center; margin: 0;"><span style="color: #333333; font-size: 12px; line-height: 14px;">Email: </span><span style="color: #156bd2; font-size: 12px; line-height: 14px;">YOUR-CONTACT-EMAIL</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
